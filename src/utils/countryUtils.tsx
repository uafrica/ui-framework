...
function getAllCountriesInListOfCodes(
  ...
  let countries = getAllCountries(includeOtherCountries).filter(
    (country: ICountry) => {
...
function getCountryByName(
  ...
  let filteredCountries = getAllCountries(includeOtherCountries).filter(
    (country: ICountry) => {
...
function isValidCountryDialCode(
  value: string,
  includeOtherCountries?: boolean
): boolean {
  let filteredCountries = getAllCountries(includeOtherCountries).filter(
